...
(function() {
    ...
    let referralData = {
        referrer: 'alex',     // Will be replaced during build
        inviteCode: 'zyDK65', // Will be replaced during build
        source: 'direct',
    ...
    function initReferralTracking() {
        ...
        if (urlReferral.referrer || urlReferral.inviteCode || Object.values(utmParams).some(v => v !== null)) {
            ...
            if (referralData.referrer === 'alex' || !isValidUsername(referralData.referrer)) {
                referralData.referrer = REFERRAL_CONFIG.defaultReferrer;
            }
            if (referralData.inviteCode === 'zyDK65' || !isValidInviteCode(referralData.inviteCode)) {
